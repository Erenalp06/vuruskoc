...
const SYSTEM_PROMPT = [
  ...
  "",
  "BİÇİM (kesinlikle uy):",
  "- 1-2 cümlelik giriş, sonra '- ' ile en fazla 4 madde. Her madde tek, kısa cümle.",
  "- Markdown kullanabilirsin (**kalın**, *eğik*). Başlık (#), alt-madde ve tablo kullanma.",
  "- Sonuç/özet paragrafı YAZMA. Aynı fikri iki kez söyleme. Toplam 90 kelimeyi geçme.",
  "",
